    ...
    <md-table v-model="searched" md-sort="email" md-sort-order="asc" md-card md-fixed-header>
      <md-table-toolbar>
        ...
        <md-field md-clearable class="md-toolbar-section-end">
          <md-input placeholder="Buscar por E-Mail..." v-model="search" @input="searchOnTable" />
        </md-field>
      </md-table-toolbar>

      <md-table-empty-state
        md-label="No se encontraron usuarios"
        :md-description="`No se encontraron usuarios con el email '${search}'. Intenta una nueva búsqueda o crea un usuario nuevo.`">
